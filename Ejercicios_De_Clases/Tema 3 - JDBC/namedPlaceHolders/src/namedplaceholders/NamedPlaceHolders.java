...
public class NamedPlaceHolders {
  ...
  public static void main(String[] args) {
    ...
    try (
      ...
      try (
              NamedParameterStatement sInsert = c.namedParameterStatement("INSERT INTO CLIENTES1(DNI,APELLIDOS,CP) VALUES (:dni,:ape,:cp);")) {

        c.setAutoCommit(false);

        int i = 0;
        sInsert.setString("dni", "54320198V");
