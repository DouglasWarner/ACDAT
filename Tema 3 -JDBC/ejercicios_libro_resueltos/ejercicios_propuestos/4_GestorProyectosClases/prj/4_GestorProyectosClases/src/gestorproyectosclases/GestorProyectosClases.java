...
public class GestorProyectosClases {
    ...
    public static void main(String[] args) {
        ...
        try (Connection c = GestorProyectosClases.obtenConexion()) {
            ...
            try {
                ...
                p2.setJefeProy(e4);
                p2.setfInicio(Date.valueOf("2021-10-01"));
                p2.setfFin(null);
                if(p2.save(c) != null) {
                    nProy++;
