...
import static ejemplo.dao.Cliente.muestraErrorSQL;
...
public class Producto {
    ...
    public Producto() 
    {
        setEan(String.valueOf(java.sql.Types.NULL));
        setNom_producto(String.valueOf(java.sql.Types.NULL));
        setPrecio_unitario(java.sql.Types.NULL);
    }
